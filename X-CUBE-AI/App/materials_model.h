/**
  ******************************************************************************
  * @file    materials_model.h
  * @author  AST Embedded Analytics Research Platform
  * @date    2025-05-23T21:21:53+0800
  ...
  ******************************************************************************
  */
#ifndef AI_MATERIALS_MODEL_H
#define AI_MATERIALS_MODEL_H

#include "materials_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MATERIALS_MODEL_MODEL_NAME          "materials_model"
#define AI_MATERIALS_MODEL_ORIGIN_MODEL_NAME   "v7_v3_48_conv2d_model"

/******************************************************************************/
#define AI_MATERIALS_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MATERIALS_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MATERIALS_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MATERIALS_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_MATERIALS_MODEL_IN \
  ai_materials_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MATERIALS_MODEL_IN_SIZE { \
  AI_MATERIALS_MODEL_IN_1_SIZE, \
}
#define AI_MATERIALS_MODEL_IN_SIZE_BYTES { \
  AI_MATERIALS_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_MATERIALS_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MATERIALS_MODEL_IN_1_HEIGHT      (48)
#define AI_MATERIALS_MODEL_IN_1_WIDTH       (13)
#define AI_MATERIALS_MODEL_IN_1_CHANNEL     (1)
#define AI_MATERIALS_MODEL_IN_1_SIZE        (624)
#define AI_MATERIALS_MODEL_IN_1_SIZE_BYTES  (2496)

/******************************************************************************/
#define AI_MATERIALS_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MATERIALS_MODEL_OUT \
  ai_materials_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MATERIALS_MODEL_OUT_SIZE { \
  AI_MATERIALS_MODEL_OUT_1_SIZE, \
}
#define AI_MATERIALS_MODEL_OUT_SIZE_BYTES { \
  AI_MATERIALS_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_MATERIALS_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MATERIALS_MODEL_OUT_1_CHANNEL     (4)
#define AI_MATERIALS_MODEL_OUT_1_SIZE        (4)
#define AI_MATERIALS_MODEL_OUT_1_SIZE_BYTES  (16)

/******************************************************************************/
#define AI_MATERIALS_MODEL_N_NODES (17)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup materials_model
 ...
 * @ref ai_materials_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_materials_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_materials_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_materials_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MATERIALS_MODEL_*
 * defines into file @ref materials_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_materials_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MATERIALS_MODEL_H */
